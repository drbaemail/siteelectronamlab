...
import { ShoppingCart, Star, Filter, Music, X, Plus, Minus, Trash2 } from 'lucide-react';
      ...
      >
        ...
        {items.length > 0 && (
          <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-white/5 bg-dark-950/90 backdrop-blur-xl">
            ...
            <button className="w-full btn-neon-filled py-3 text-xs justify-center rounded">
              Checkout
            </button>
          </div>
        )}
    ...
    >
      ...
      <div className="p-5">
        ...
        <button
          ...
          className="w-full btn-neon text-[0.65rem] py-2 justify-center rounded"
        >
